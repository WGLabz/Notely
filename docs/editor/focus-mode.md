...
description: Use Focus Mode to minimize distractions and the Outline panel to navigate long notes by heading.
keywords: focus mode, outline, navigation, heading, distraction-free
category: Editor
---
...
| Status bar padding | Reduced |
| Surrounding UI | Simplified |
