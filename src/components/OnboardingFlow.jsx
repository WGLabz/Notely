                      ...
                      <div style={{ padding: "10px", background: "var(--surface-muted)", border: "1px solid var(--border-soft)", borderRadius: "6px", marginBottom: "4px" }}>
                        ...
                        {graphModelStatus.downloaded ? (
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            <span style={{ fontSize: "12px", color: "var(--text-muted)" }}>Offline zero-shot graph extraction weights.</span>
                            <button
                              type="button"
                              className="btn"
                              onClick={async () => {
                        ...
                        <div style={{ color: "var(--text-muted)", fontSize: "10.5px", marginTop: "6px", borderLeft: "2px solid var(--accent-solid)", paddingLeft: "6px" }}>
                          💡 <strong>Zero-Shot Extraction:</strong> GLiNER & GLiREL run in a background worker process, extracting entities and relations directly on CPU without cloud APIs.
                        </div>
                      </div>
                    ) : (
